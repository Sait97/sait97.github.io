          ...
          <ul className="row grid justify-content-center">
            ...
            >
              <figure onClick={toggleModalOne}>
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Kesten-76</span>
                </div>
              </figure>
            ...
            >
              <figure onClick={toggleModalTwo}>
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Eastland</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Back-End Project</span>
                </div>
              </figure>
            ...
            >
              ...
              >
                ...
                <div className=" hover-content-wrapper">
                  <span className="content-title">Project</span>
                </div>
              </figure>
