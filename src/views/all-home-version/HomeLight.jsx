...
import CertificatLight from "../../components/blog/CertificateLight";
...
const menuItem = [
  ...
  { icon: "fa-certificate", menuName: "Certificates" },
    ...
    <div className="green">
      ...
      <Tabs>
        ...
        <div className="tab-panel_list">
          ...
          <TabPanel className="certificates">
            <div
              className="title-section text-left text-sm-center "
              data-aos="fade-up"
              data-aos-duration="1200"
            >
              ...
              <span className="title-bg">awards</span>
            </div>
            <div
              className="container"
              data-aos="fade-up"
